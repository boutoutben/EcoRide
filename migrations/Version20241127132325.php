 ...
 */
final class Version20241127132325 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, carpool_participation_id INT DEFAULT NULL, name VARCHAR(50) DEFAULT NULL, surname VARCHAR(50) DEFAULT NULL, email VARCHAR(255) NOT NULL, phone INT DEFAULT NULL, pseudo VARCHAR(100) NOT NULL, nb_credit INT NOT NULL, img VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, INDEX IDX_8D93D649D8685255 (carpool_participation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
